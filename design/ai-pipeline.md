...
- 같은 날 회의에서 위키백과를 근거 검색에서 빼기로 했다. 위키백과가 붙은 주장이 대부분 근거 부족으로 처리돼 검증이 불명확했기 때문이다. 이 목록은 회의 이전의 연결 상태이며, 제외 반영 여부는 [프로젝트 계획](../project/project-plan.md#미결-사항과-일정-확인)에서 확인한다. 근거는 [9월 13일 회의록](../meetings/2026-09-13-integration.md#결정-사항)이다.
